...
This takes exactly the same parameters as C<parsefile()> but instead
returns a XML::Tiny::DOMmish::Node object that you can query in a
sort-of DOMmish way.

It provides the following methods:

=head3 various created by AUTOLOAD
